...
import { ArrowLeft, ThumbsUp, AlertCircle, Home } from 'lucide-react';
        ...
        <div className="min-h-screen bg-background">
            <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white">
                <div className="flex items-center gap-3 p-4 max-w-lg mx-auto">
                    ...
                    <h1 className="text-xl">AI 피드백</h1>
                </div>
            ...
            <div className="p-6 max-w-lg mx-auto space-y-4 -mt-4">
                <Card className="p-6 bg-white shadow-lg">
                    ...
                    <ResponsiveContainer width="100%" height={250}>
                        <RadarChart data={radarData}>
                            ...
                            <Radar name="평가" dataKey="value" stroke="#8b5cf6" fill="#8b5cf6" fillOpacity={0.6} />
                        </RadarChart>
                    </ResponsiveContainer>
                </Card>
                ...
                <Card className="p-5 border-2 border-green-200 bg-green-50">
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                            <h3 className="mb-2 text-green-900">잘한 점</h3>
                ...
                <Card className="p-5 border-2 border-amber-200 bg-amber-50">
                    <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                            <h3 className="mb-2 text-amber-900">개선하면 좋은 점</h3>
